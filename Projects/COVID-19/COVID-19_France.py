...
dataFrance = data[(data['Country/Region'] == 'France')].reset_index(drop=True)
dataItaly_op = dataFrance.groupby(['ObservationDate', 'Country/Region'])[
...
figure.update_layout(title='Evolution of Confirmed, Active cases in France', template='plotly_white')
